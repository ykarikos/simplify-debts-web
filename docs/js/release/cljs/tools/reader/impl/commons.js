...
var G__6254 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__6254;
continue;
} else {
return ch;
...
var vec__6255 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6255,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq6258){
...
return (function() { 
var G__6263__delegate = function (rdr,_){
...
var G__6263 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__6264__i = 0, G__6264__a = new Array(arguments.length -  1);
while (G__6264__i < G__6264__a.length) {G__6264__a[G__6264__i] = arguments[G__6264__i + 1]; ++G__6264__i;}
  _ = new cljs.core.IndexedSeq(G__6264__a,0,null);
} 
return G__6263__delegate.call(this,rdr,_);};
G__6263.cljs$lang$maxFixedArity = 1;
G__6263.cljs$lang$applyTo = (function (arglist__6265){
var rdr = cljs.core.first(arglist__6265);
var _ = cljs.core.rest(arglist__6265);
return G__6263__delegate(rdr,_);
});
